...
export default function OrderPage() {
  ...
  const { categories, setCategories, selectedCategory, setSelectedCategory, newCategory, setNewCategory, deleteCategory, addCategory, resetCategoryAndProducts } = useCategories()
